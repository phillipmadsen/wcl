                            ...
                            <div class="row carousel-content center-vertically-right">
                                <div class="fadeInRight-animated" data-animation="fadeInRight">
                                    <div class="carousel-description col-sm-5">
                                        <h3 class="heavy text-white" itemprop="name"><span class="carousel-title-bgclear">{{ trans('app.frontend.home.carousel.1.title') }}</span></h3>
                                        <p>
                                            {!! trans('app.frontend.home.carousel.1.content') !!}
                                        </p>
                                        <a href="{{ route('blog.index') }}" class="btn btn-rw btn-default" itemprop="url">{{ trans('app.frontend.home.carousel.1.link') }} <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                                <div class="fadeInLeft-animated" data-animation="fadeInLeft">
                                    <div class="col-sm-6 col-sm-offset-1">
                                        <img src="/assets/img/showcase-full.png" class="img-responsive carousel-image" alt="Responsive Showcase" width="540" height="270px" itemprop="image" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row carousel-content center-vertically-left">
                                <div class="fadeInLeft-animated" data-animation="fadeInLeft">
                                    <div class="col-sm-6 hidden-xs">
                                        <img src="/assets/img/showcase2.png" width="510" height="328" class="img-responsive carousel-image" alt="Responsive Showcase" itemprop="image" />
                                    </div>
                                </div>
                                <div class="fadeInRight-animated" data-animation="fadeInRight">
                                    <div class="carousel-description mt10 col-sm-5 col-sm-offset-1">
                                        <h4 class="heavy text-white" itemprop="name"><span class="carousel-title-bg">{{ trans('app.frontend.home.carousel.2.title') }}</span></h4>
                                        <p>
                                            {!! trans('app.frontend.home.carousel.2.content') !!}
                                        </p>
                                        <a href="{{ route('blog.index') }}" class="btn btn-rw btn-primary" itemprop="url">{{ trans('app.frontend.home.carousel.2.link') }} <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row carousel-content center-vertically-right">
                                <div class="fadeInUpBig-animated" data-animation="fadeInUpBig">
                                    <div class="carousel-description col-sm-8 col-sm-offset-2 text-center">
                                        <h2 class="heavy text-white" itemprop="name"><span class="carousel-title-bgclear">{{ trans('app.frontend.home.carousel.3.title') }}</span></h2>
                                        <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 fadeInUp-animated text-center">
                    ...
                    <h4 class="mt15" itemprop="name">{{ trans('app.frontend.home.three-reasons.1.title') }}</h4>
                ...
                <div class="col-sm-4 fadeInUp-animated text-center mt20-xs">
                    ...
                    <h4 class="mt15" itemprop="name">{{ trans('app.frontend.home.three-reasons.2.title') }}</h4>
                    <p class="p15xs no-margin">
                ...
                <div class="col-sm-4 fadeInUp-animated text-center mt20-xs">
                    ...
                    <h4 class="mt15" itemprop="name">{{ trans('app.frontend.home.three-reasons.3.title') }}</h4>
                    <p class="p15xs no-margin">
    ...
    <div class="mt40 mb40">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title" itemprop="name"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" itemprop="additionalType">{{ trans('app.frontend.home.about-me.1.title') }}</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title" itemprop="name"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" itemprop="additionalType">{{ trans('app.frontend.home.about-me.2.title') }}</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title" itemprop="name"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" itemprop="additionalType">{{ trans('app.frontend.home.about-me.3.title') }}</a></h4>
                            </div>
                ...
                <div class="col-sm-6 reveal">
                    <img src="/assets/img/showcase.png" width="555" height="316" class="img-responsive showcase-image" alt="Responsive Showcase" itemprop="image">
                </div>
            </div>
            {{-- /Accordion --}}
        </div>
    ...
    <section class="mb40">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading mb30">
                        <h4 itemprop="name">{{ trans('app.frontend.home.customers.title') }}</h4>
                        <div class="owl-controls">
                            <div id="customNav" class="owl-nav"></div>
                        </div>
                    </div>
